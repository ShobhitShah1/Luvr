...
export const FakeUserCard: ProfileType[] = [
  {
    ...
    fullName: 'John Doe',
    gender: 'Male',
    habits_drink: 'Regularly',
    habits_exercise: 'Regularly',
    habits_movies: 'Daily',
    habits_smoke: 'Never',
    hoping: 'New Friends',
    identity: 'ID1',
    ...
    loginType: 'Email',
    magical_person_communication_str: 'Extrovert',
    magical_person_education_level: 'Graduate',
    magical_person_received_love: 'Yes',
    magical_person_star_sign: 'Libra',
    orientation: ['Straight'],
    profileImage: 'https://example.com/profile-image-1.jpg',
    radius: 10,
    recentPik: imageArray.reverse(),
  },
  {
    id: 2,
    ...
    education_degree: 'Master of Arts',
    fullName: 'Jane Smith',
    gender: 'Female',
    habits_drink: 'Never',
    habits_exercise: 'Sometimes',
    habits_movies: 'Daily',
    habits_smoke: 'Never',
    ...
    loginType: 'Social',
    magical_person_communication_str: 'Extrovert',
    magical_person_education_level: 'Postgraduate',
    magical_person_received_love: 'Yes',
    magical_person_star_sign: 'Taurus',
    orientation: ['Pansexual'],
    profileImage: 'https://example.com/profile-image-2.jpg',
    radius: 15,
    recentPik: imageArray,
  },
  {
    id: 3,
    ...
    education_degree: 'Ph.D. in Economics',
    ...
    loginType: 'Email',
    magical_person_communication_str: 'Extrovert',
    magical_person_education_level: 'Doctorate',
    magical_person_received_love: 'Yes',
    magical_person_star_sign: 'Cancer',
    orientation: ['Demisexual'],
    profileImage: 'https://example.com/profile-image-3.jpg',
    radius: 12,
    recentPik: imageArray.reverse(),
  },
  {
    id: 4,
    mobile_number: '987-654-9876',
    ...
    gender: 'Female',
    habits_drink: 'Never',
    habits_exercise: 'Never',
    habits_movies: 'Weekly',
    habits_smoke: 'Never',
    ...
    loginType: 'Social',
    magical_person_communication_str: 'Extrovert',
    magical_person_education_level: 'Undergraduate',
    magical_person_received_love: 'Yes',
    magical_person_star_sign: 'Pisces',
    orientation: ['Heterosexual'],
    profileImage: 'https://example.com/profile-image-4.jpg',
    radius: 18,
    recentPik: imageArray,
  },
  {
    id: 5,
    mobile_number: '123-789-4560',
    ...
    habits_drink: 'Never',
    habits_exercise: 'Regularly',
    habits_movies: 'Rearly',
    habits_smoke: 'Never',
    hoping: 'perfer Not To Say',
    identity: 'ID5',
    is_orientation_visible: true,
    isVerified: true,
    latitude: 35.6895,
    ...
    likes_into: ['Harry Potter', 'Art Lover', 'Film Buff'],
    loginType: 'Email',
    magicalPersonCommunicationStr: 'Extrovert',
    magical_person_education_level: 'Postgraduate',
    magical_person_received_love: 'Yes',
    magical_person_star_sign: 'Scorpio',
    orientation: ['Pansexual'],
    profileImage: 'https://example.com/profile-image-5.jpg',
    radius: 15,
    recentPik: imageArray.reverse(),
  },
];
...
//     orientation: ['Straight'],
//     profile_image: 'https://example.com/profile-image-1.jpg',
//     radius: 10,
//     recent_pik: imageArray.reverse(),
...
//     mobile_no: '555-1234',
//     orientation: ['Demisexual'],
//     profile_image: 'https://example.com/profile-image-3.jpg',
//     radius: 12,
//     recent_pik: imageArray.reverse(),
//     user_from: 'United Kingdom',
//   },
//   {
//     _id: '4',
//     birthdate: '1992-03-12',
...
//       star_sign: 'Pisces',
//     },
//     mobile_no: '987-654-9876',
//     orientation: ['Heterosexual'],
//     profile_image: 'https://example.com/profile-image-4.jpg',
//     radius: 18,
//     recent_pik: imageArray,
//     user_from: 'Australia',
//   },
...
//       star_sign: 'Scorpio',
//     },
//     mobile_no: '123-789-4560',
//     orientation: ['Pansexual'],
//     profile_image: 'https://example.com/profile-image-5.jpg',
//     radius: 15,
//     recent_pik: imageArray.reverse(),
//     user_from: 'Japan',
//   },
...
export const alertData = [
  {
    ...
    confirmButton: 'Yes, Remove the Image',
    cancelButton: 'No, Keep the Memory',
  },
  {
    title: 'Pixel Farewell Decision!',
    message:
      'Ready to bid farewell to this image? Deleting it is like closing a chapter in the digital story of your dating profile. Still interested in a fresh start?',
    confirmButton: 'Farewell, Pixel!',
    cancelButton: 'Hold on, Keep the Digital Tale',
  },
];
