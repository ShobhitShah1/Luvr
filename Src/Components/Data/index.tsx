...
export const SmokingDrinkingFrequencyData: string[] = ['Regularly', 'Rarely', 'Never'];

export const MovieWatchingFrequencyData: string[] = ['Daily', 'Weekly', 'Monthly'];
...
export const LookingFor: string[] = [
  // Primary relationship intentions
  'A Relationship',
